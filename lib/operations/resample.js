...
module.exports = function(input, output, options, callback) {
  ...
  var args = [
    ...
    "-srcnodata", -32768,
    "-dstnodata", -32768,
    "-wm", 256, // allow GDAL to work in 512MB chunks (diminishing returns beyond this, supposedly)
    ...
    "-cwhere", util.format("ZONE = '%s' AND HEMISPHERE = '%s'", zone, hemi), // target a specific UTM zone
